...
function StepMemories({ formData, setFormData }) {
    ...
    return (
        <div className="space-y-8 animate-fade-in-up">
            ...
            {/* Conditional Chat History Display */}
                ...
                <div className="space-y-2 animate-fade-in-up">
                    <div className="flex justify-between items-center">
                        <label className="block text-sm font-medium text-[#555] uppercase tracking-wide">
                            Chat History / Letters
                        </label>
                        <button
                            onClick={() => handleChange('chatHistory', null)}
                            className="text-xs text-red-500 hover:text-red-700 font-medium transition-colors"
                        >
                            Remove
                        </button>
                    </div>
                    <div className="bg-white/60 border border-white/50 rounded-xl p-4 flex items-center gap-4 shadow-sm">
                        <div className="w-12 h-12 bg-[#ccff00]/20 rounded-lg flex items-center justify-center text-[#556b00]">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-bold text-[#333] truncate">{formData.chatHistory.name}</p>
                            <p className="text-xs text-[#666]">Uploaded • Ready for analysis</p>
                        </div>
                        <div className="text-[#ccff00] bg-white rounded-full p-1 shadow-sm">
